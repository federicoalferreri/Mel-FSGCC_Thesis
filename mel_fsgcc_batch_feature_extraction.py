...
def main(argv):
    ...
    if params['mode'] == 'dev':
        dev_feat_cls = pytorch_mel_fsgcc_cls_feature_class.FeatureClass(params, is_eval=False)
        ...
        dev_feat_cls = pytorch_mel_fsgcc_cls_feature_class.FeatureClass(params, is_eval=True)
