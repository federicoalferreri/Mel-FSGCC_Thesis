...
room.add_source([13.5, 2.73, 1.76])
room.add_source([10.5, 6.73, 2.7])
room.add_source([3.5, 9.73, 1.0])
room.add_source([5.5, 14.73, 0.6])
room.add_source([7.5, 17.73, 1.3])

source_locs = np.array([
    np.array([13.5, 2.73, 1.76]),
    np.array([10.5, 6.73, 2.7]),
    np.array([3.5, 9.73, 1.0]),
    np.array([5.5, 14.73, 0.6]),
    np.array([7.5, 17.73, 1.3]),
])
