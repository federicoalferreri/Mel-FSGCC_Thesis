...
RIR_DIR = (
    "/nas/home/fferreri/SpatialScaper/datasets/rir_datasets"  # Directory containing Room Impulse Response (RIR) files
)
ROOM = "arni"  # Initial room setting, change according to available rooms listed below
...
OUTPUT_DIR = "/nas/home/fferreri/SpatialScaper/output"  # Directory to store the generated soundscapes
REF_DB = (
    -65
